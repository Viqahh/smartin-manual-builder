...
| PRD-OQ-002 | **Inspector tabs.** `ROUTES_AND_COMPONENTS.md` specifies completion / validation / metadata (3 tabs); Phase 1 shipped 2 (Validasi with score folded in, Metadata). Keep 2 or restore 3? | Phase 3–5 |
